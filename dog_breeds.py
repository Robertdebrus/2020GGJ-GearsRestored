  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Robertdebrus/2020GGJ-GearsRestored/blob/master/dog_breeds.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "source": [
        ...
        "\"\"\"\n",
        "\n",
        "_IMAGES_URL = '/deepData/DogBreedProject/Images'\n",
        "_SPLIT_URL = '/deepData/DogBreedProject/lists.tar'\n",
        "_ANNOTATIONS_URL = '/deepData/DogBreedProject/annotation.tar'\n",
